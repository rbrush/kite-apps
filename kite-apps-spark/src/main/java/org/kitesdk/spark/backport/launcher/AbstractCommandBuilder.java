...
abstract class AbstractCommandBuilder {
  ...
  List<String> buildClassPath(String appClassPath) throws IOException {
    ...
    String assembly = getenv(CommandBuilderUtils.ENV_SPARK_ASSEMBLY);
    if (assembly == null && CommandBuilderUtils.isEmpty(getenv("SPARK_TESTING"))) {
    ...
    CommandBuilderUtils.checkState(libdir.isDirectory(), "Library directory '%s' does not exist.",
  ...
  String getScalaVersion() {
    ...
    CommandBuilderUtils.checkState(!scala210.isDirectory() || !scala211.isDirectory(),
        "Presence of build for both scala versions (2.10 and 2.11) detected.\n" +
            "Either clean one of them or set SPARK_SCALA_VERSION in your environment.");
    if (scala210.isDirectory()) {
      return "2.10";
    } else {
      CommandBuilderUtils.checkState(scala211.isDirectory(), "Cannot find any assembly build directories.");
      return "2.11";
    }
  }
