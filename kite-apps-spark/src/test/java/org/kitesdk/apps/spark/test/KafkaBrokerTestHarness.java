 ...
 * <p>
 * The logic is based on the {@code kafka.integration.KafkaServerTestHarness} class.
 * </p>
 */
public class KafkaBrokerTestHarness extends ZookeeperTestHarness {
  ...
  public Properties getProducerProps() {
    ...
    props.setProperty("metadata.broker.list", brokers.toString());
  ...
  public List<Properties> getBrokerProps() {
    ...
    for (KafkaServer broker : brokers) {
      props.add(broker.config().props().props());
    }
    return props;
  }
